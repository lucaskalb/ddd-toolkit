...
/**
 * Interface representing an execution context that carries cross-cutting information.
 * <p>
 * Context provides a way to pass additional information through domain operations
 * without polluting method signatures. This is particularly useful for concerns like:
 * <ul>
...
public interface Context {
   ...
   * <p>
   * The metadata map provides a flexible way to store and retrieve context information
   * using string keys. Implementations should ensure this map is mutable to support
   * the {@link #addMetadata(String, Object)} method.
   * </p>
   * 
   * @return a map containing context metadata, may be null if no metadata is supported
   */
   ...
   * <p>
   * This is a convenience method that adds information to the metadata map if it exists.
   * If the metadata map is null, this method does nothing and still returns the context
   * for method chaining.
   * </p>
   * <p>
