 ...
 * <p>
 * Domain Events represent something important that happened in the domain that
 * domain
 * experts care about. They capture the business significance of state changes
 * and allow
 * for decoupled communication between different parts of the domain.
 * </p>
 * <p>
 * All domain events must provide a timestamp indicating when the event
 * occurred.
 * This enables event sourcing, auditing, and temporal queries on the domain
 * model.
 * </p>
 * <p>
...
public interface DomainEvent {
   ...
   * <p>
   * This timestamp is crucial for event ordering, replay scenarios, and auditing
   * purposes.
   * It should typically be set when the event is created and remain immutable
   * thereafter.
   * </p>
   * 
