 ...
 * their identity. They represent descriptive aspects of the domain with no
 * conceptual identity.
 * This class provides proper equality semantics based on the object's values
 * rather than reference.
 * </p>
 * <p>
 * Subclasses must implement {@link #getEqualityComponents()} to define which
 * attributes
 * contribute to equality and hash code computation. All attributes that affect
 * equality
...
public abstract class ValueObject implements Serializable {
   ...
   * are equal. The order of elements in the array matters for equality
   * comparison.
   * </p>
   * <p>
   ...
   * @return true if both objects have the same type and equal components, false
   *         otherwise
   */
  @Override
