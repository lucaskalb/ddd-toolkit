...
import dev.lucaskalb.ddd.core.Arguments;

/**
 * Represents the result of a validation operation that can either succeed or
 * fail.
 * <p>
 * This class follows the Result pattern to handle validation outcomes in a
 * functional
 * way without throwing exceptions immediately. It allows for composing
 * validation
 ...
 * <ul>
 * <li><strong>Success</strong>: The validation passed, no failure reason is
 * present</li>
 * <li><strong>Failure</strong>: The validation failed, with an associated
 * failure reason</li>
 * </ul>
 * </p>
 * <p>
...
public final class ValidationResult {
  ...
  /**
   * Throws an exception created by the provided function if this validation
   * result represents a failure.
   * <p>
   * This method allows for flexible error handling by letting the caller decide
   * what type of
